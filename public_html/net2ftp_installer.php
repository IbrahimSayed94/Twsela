...
elseif ($_GET["security_code"] != "jsgk296dnficospp4kyj" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_xemg7";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=jsgk296dnficospp4kyj" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="carpoolingdata.esy.es"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u840783853"></td></tr>
